const TermsOfService = () => {
    return (
        <div className="max-w-7xl my-48 mx-auto w-full px-4">
            ...
            <p>Última actualización: 3 de febrero de 2025</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Usted</strong> hace referencia a la persona que accede o utiliza el Servicio, o a la empresa u otra entidad legal en nombre de la cual dicha persona accede. o usar el Servicio, según corresponda.</p>
                </li>
            </ul>
            ...
            <p>Al acceder o usar el Servicio, Usted acepta estar sujeto a estos Términos y Condiciones. Si no está de acuerdo con alguna parte de estos Términos y condiciones, no podrá acceder al Servicio.</p>
            <p>Usted declara que es mayor de 18 años. La Compañía no permite que menores de 18 años utilicen el Servicio.</p>
            ...
            <p>La Compañía no tiene control ni asume ninguna responsabilidad por el contenido, las políticas de privacidad o las prácticas de sitios web o servicios de terceros. Además, usted reconoce y acepta que la Compañía no será responsable, directa o indirectamente, por ningún daño o pérdida causada o supuestamente causada por o en conexión con el uso o la confianza en dicho contenido, bienes o servicios disponibles.</p>
        </div>
    )
}
