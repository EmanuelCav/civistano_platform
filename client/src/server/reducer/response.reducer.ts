...
const counterResponseSlice = createSlice({
    ...
    extraReducers(builder) {
        ...
        builder.addCase(userAction.restartAncestryUser.pending, (state) => {
            state.loading = true
        })
        builder.addCase(userAction.restartAncestryUser.fulfilled, (state) => {
            state.loading = false
        })
        builder.addCase(userAction.restartAncestryUser.rejected, (state) => {
            state.loading = false
        })

        builder.addCase(userAction.checkAncestryUser.pending, (state) => {
            state.loading = true
        })
        builder.addCase(userAction.checkAncestryUser.fulfilled, (state) => {
            state.loading = false
        })
        builder.addCase(userAction.checkAncestryUser.rejected, (state) => {
            state.loading = false
        })
    }
})
