...
const InputUpdate = ({ question, error, register, text }: InputUpdatePropsType) => {
    return (
            ...
            {error && <p className="text-red-500 text-xs italic my-2">{error.message}</p>}
                ...
                <div className="flex items-center gap-4">
                    <input
                        ...
                        defaultValue={0}
                        className={
                            `bg-gray-50 border text-center text-gray-900 text-md rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2.5 w-28 
