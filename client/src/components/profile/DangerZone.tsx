...
const DangerZone = ({ handleIsRestart, handleIsRemove, handleIsLogout, completeAncestry, ancestors, ancestryNumber, ancestor }: DangerZonePropsType) => {
